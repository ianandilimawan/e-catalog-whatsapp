...
<!-- Page Header -->
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
                <h2 class="lg:text-2xl text-xl font-bold text-gray-900 dark:text-white">Stores</h2>
                <p class="mt-1 lg:text-sm text-xs text-gray-600 dark:text-gray-400">Manage your stores here</p>
            </div>
            <div class="flex flex-wrap gap-3">
                @if(auth()->user() && auth()->user()->hasPermission('create-stores'))
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 dark:border-gray-800 overflow-hidden p-2">
            <livewire:tables.store-table />
        </div>
    </div>

    <!-- Delete Confirmation Modal -->
    <x-confirm-delete-modal title="Delete Store"
