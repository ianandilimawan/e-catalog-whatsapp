    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <h1 class="lg:text-2xl text-xl font-semibold text-gray-900 dark:text-white">Category Details</h1>
            </div>
        </div>

        @if (auth()->user()->hasPermission('edit-categories'))
            <a href="{{ route('admin.categories.edit', $category) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors text-sm font-semibold shadow-sm hover:shadow-md">
