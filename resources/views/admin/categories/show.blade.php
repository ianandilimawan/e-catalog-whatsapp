...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        @if (auth()->user()->hasPermission('edit-categories'))
            <a href="{{ route('edit-categories', $category) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors text-sm font-semibold shadow-sm hover:shadow-md">
