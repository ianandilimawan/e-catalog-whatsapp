    ...
    <div id="loginContainer"
        ...
        <div
            ...
            <div class="w-full lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
                ...
                <!-- Login Form -->
                <form class="space-y-5" action="{{ route('login.post') }}" method="POST" id="loginForm">
                    @csrf
                ...
                <div class="text-center mt-10">
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-semibold text-blue-600 dark:text-blue-400 hover:underline underline-offset-2">Daftar di sini</a>
                    </p>
                    <p class="text-xs font-medium text-zinc-400 dark:text-zinc-600 mt-4">
