...
@section('content')
    <div class="space-y-6">
        <!-- Page Header -->
        <div>
            <h1 class="lg:text-2xl text-xl font-semibold text-gray-900 dark:text-white">Edit Permission</h1>
            <p class="mt-1 lg:text-sm text-xs text-gray-600 dark:text-gray-400">Update permission information</p>
        </div>
